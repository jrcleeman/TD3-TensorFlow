...
while total_timesteps < max_timesteps:
	...
	if total_timesteps < start_timesteps:
		action = [random.uniform(-1, 1), random.uniform(-1, 1), random.uniform(-1, 1)]#env.action_space.sample()
	...
	done_bool = done #0 if episode_timesteps + 1 == env._max_episode_steps else float(done)
